...
extension UIScreen {
    ...
    public static let SCREEN_W_12Mini: CGFloat = 360
    public static let SCREEN_H_12Mini: CGFloat = 780
    public static let SCREEN_W_12Pro: CGFloat = 390
    public static let SCREEN_H_12Pro: CGFloat = 844
    public static let SCREEN_W_12ProMax: CGFloat = 428
    public static let SCREEN_H_12ProMax: CGFloat = 926
    ...
    public static var isiPhoneXMore: Bool {
        ...
        if (kWidth == SCREEN_W_12Mini) && (kHeight == SCREEN_H_12Mini) {
            return true
        }
        if (kWidth == SCREEN_W_12Pro) && (kHeight == SCREEN_H_12Pro) {
            return true
        }
        if (kWidth == SCREEN_W_12ProMax) && (kHeight == SCREEN_H_12ProMax) {
            return true
        }
        return false
    }
